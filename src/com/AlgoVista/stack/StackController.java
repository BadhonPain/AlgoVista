...
public class StackController {
                ...
                if (success) {
                    ...
                    Platform.runLater(() -> {
                        ...
                        if (indexInVBox >= 0 && indexInVBox < stackContainer.getChildren().size()) {
                            VBox cellBox = (VBox) stackContainer.getChildren().get(indexInVBox);
            ...
            try {
                ...
                for (int i = top; i >= 0; i--) {
                    ...
                    Platform.runLater(() -> {
                        ...
                        VBox cellBox = (VBox) stackContainer.getChildren().get(vBoxIdx);
                        Label dataLabel = (Label) cellBox.getChildren().get(0);
                        String oldStyle = dataLabel.getStyle();
    ...
    private void traverse() {
        ...
        logStep("Traversed and outputted " + model.size() + " elements.");
    }
    ...
    private HBox createStackCell(String valStr, int index, boolean isActive, boolean isTop) {
        ...
        idxMarker.setStyle("-fx-text-fill: #7f8c8d; -fx-font-size: 11; -fx-min-width: 25;");
